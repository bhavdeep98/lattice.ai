...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function formatAIResponse(content) {
    ...
    content = content.replace(
      /^✅ \*\*(.*?)\*\*: (.*$)/gm,
      '<div class="guardrail-item">✅ <strong>$1</strong>: $2</div>'
    );
    content = content.replace(
      /^🚀 \*\*(.*?)\*\*: (.*$)/gm,
      '<div class="deployment-note">🚀 <strong>$1</strong>: $2</div>'
    );

    // Handle module descriptions
    content = content.replace(
      /^\*\*(🌐|🗄️|🔐|🗃️|⚙️) (.*?)\*\*: (.*$)/gm,
      '<div class="module-description"><span class="module-icon">$1</span> <strong>$2</strong>: $3</div>'
    );
  ...
  function generateAIResponse(userMessage) {
    ...
    if (
      ...
      response =
        "I'll create a HIPAA-compliant healthcare platform infrastructure. Let me show you how Lattice transforms your request:";
      ...
      response =
        "I'll build a scalable e-commerce platform. Here's how Lattice processes your request:";
      ...
      (lowerMessage.includes('web app') || lowerMessage.includes('website')) &&
      !lowerMessage.includes('simple')
    ) {
      response =
        "I'll create a comprehensive web application infrastructure. Let me show you the Lattice process:";
      ...
      lowerMessage.includes('microservice')
    ) {
      response =
        "Perfect! I'll generate a production-ready REST API infrastructure. Here's the Lattice workflow:";
      ...
      response =
        "I'll create a robust data processing pipeline. Let me demonstrate the Lattice approach:";
      ...
      response =
        "I'll create a flexible, general-purpose infrastructure. Let me show you the Lattice process:";
          ...
          PaymentProcessingFunction: {
            ...
            Properties: {
              ...
              Environment: {
                Variables: {
                  STRIPE_SECRET_KEY:
                    '{{resolve:secretsmanager:stripe-key:SecretString:secret_key}}',
                },
              },
            },
          },
