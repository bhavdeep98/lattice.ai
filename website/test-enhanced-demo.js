...
async function runTests() {
    ...
    for (const testCase of testCases) {
        ...
        try {
            ...
            console.log(`   ✅ Domain: ${analysis.detectedDomain || 'null'} (expected: ${testCase.expectedDomain})`);
            console.log(`   ✅ Confidence: ${Math.round((analysis.confidence || 0) * 100)}% (expected: ${testCase.expectedConfidence})`);
