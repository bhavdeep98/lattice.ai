...
export const DEFAULT_LOGGING_CONFIG: LoggingConfig = {
  ...
  filters: {
    excludePatterns: ['health-check', 'ping', 'favicon.ico'],
    includePatterns: [],
  },
};
...
export function shouldLog(configLevel: string, messageLevel: string): boolean {
  const configLevelNum =
    LOG_LEVELS[configLevel.toUpperCase() as keyof typeof LOG_LEVELS] ?? LOG_LEVELS.INFO;
  const messageLevelNum =
    LOG_LEVELS[messageLevel.toUpperCase() as keyof typeof LOG_LEVELS] ?? LOG_LEVELS.INFO;
