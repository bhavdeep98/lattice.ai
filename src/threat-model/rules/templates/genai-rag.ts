...
export function genaiRagThreats(ctx: {
  ...
  threats.push({
    ...
    scenario: "Attacker crafts malicious prompts to manipulate AI model behavior, bypass safety controls, or extract training data.",
  ...
  threats.push({
    ...
    scenario: "RAG system retrieves and exposes documents from other tenants due to insufficient access controls.",
  ...
  threats.push({
    ...
    scenario: "Attacker injects malicious documents or embeddings to manipulate retrieval results and AI responses.",
  ...
  threats.push({
    ...
    scenario: "Attacker floods the system with expensive inference requests to exhaust budget or cause service degradation.",
  ...
  threats.push({
    ...
    scenario: "User queries, AI responses, or retrieved context containing PII/sensitive data are logged in plaintext.",
  ...
  if (ctx.hasSageMaker) {
    threats.push({
      ...
      scenario: "Compromised model endpoint gains access to training data or other AWS resources beyond intended scope.",
