...
export function generalCloudThreats(ctx: {
  ...
  if (ctx.hasDataStores) {
    threats.push({
      ...
      scenario: "Sensitive data is exposed due to misconfigured storage services or overly permissive access policies.",
  ...
  if (ctx.hasCompute) {
    threats.push({
      ...
      scenario: "Compromised compute resources gain excessive permissions to access other AWS services.",
    ...
    threats.push({
      ...
      scenario: "Attacker causes excessive resource consumption leading to service degradation or unexpected costs.",
  ...
  threats.push({
    ...
    scenario: "Lack of comprehensive logging makes it difficult to investigate security incidents or prove compliance.",
