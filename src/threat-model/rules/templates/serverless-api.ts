...
export function serverlessApiThreats(ctx: {
  ...
  threats.push({
    ...
    scenario: "Malicious input in API requests leads to injection attacks against database queries.",
  ...
  threats.push({
    ...
    scenario: "Attacker overwhelms API with requests, causing service degradation or Lambda timeout/memory issues.",
  ...
  threats.push({
    ...
    scenario: "API accidentally exposes sensitive user data, internal system information, or error details.",
  ...
  threats.push({
    ...
    scenario: "Compromised Lambda function uses excessive IAM permissions to access unintended AWS resources.",
  ...
  if (ctx.hasDynamoDB) {
    threats.push({
      ...
      scenario: "Lack of proper audit trails makes it impossible to track who made what changes to data.",
