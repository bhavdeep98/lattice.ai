...
export function generateThreats(
  ...
  switch (workloadType) {
    case "data-pipeline":
      threats.push(...dataPipelineThreats({
    ...
    case "serverless-api":
      threats.push(...serverlessApiThreats({
        hasApiGateway: services.has("apigateway"),
    ...
    default:
      ...
      threats.push(...generalCloudThreats({
